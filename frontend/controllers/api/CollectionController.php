 ...
 */
class CollectionController extends CurdController
{
    ...
    public $modelName="FormCollection";
    public $searchModelName="FormCollectionSearch";
...
//            ],
	...
	public function _create($model, $namespace = "\\frontend\\models\\")
    {
        ...
        $this->rawBody['Collection']['userid']=$uid;
