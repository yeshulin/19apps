...
<div class="user-content">
	<div class="user-main-box">
		...
		<div class="am-tabs" data-am-widget="tabs" data-am-tabs-noswipe="1">			
		    ...
		    <div class="am-tab-panel am-fade" id="tab2">
				<table width="100%"  class="list-style">
					...
					foreach($lablist as $key=>$val){
						...
						?>
						<tr >
							<td><?=$val['lab_name']?></td><td><?=date("Y-m-d H:i:s",$val['created_at'])?></td><td><?=date("Y-m-d H:i:s",$val['begin_time'])?></td><td><?=date("Y-m-d H:i:s",$val['end_time'])?></td><td><?php foreach($val['actinfo'] as $k1=>$v1){ echo $v1['activ_code']."<br>";}?></td><td><a href="<?=Url::to(["/user/lab/setgrant",'lab_id'=>$val["lab_id"],'lab_name'=>$val['lab_name']])?>">管理用户</a></td>
						</tr>
						<?php
					}
					?>
