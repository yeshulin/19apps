...
class QQapi{
    ...
    private $appkey="";
    private $callback="";
//    private $callback="http://www.sobeycollege.com/index.php";
    private $access_token='';
    private $openid='';

     public function __construct(){
         $this->appid = Yii::$app->params['appid']['qq'];
         $this->appkey = Yii::$app->params['appkey']['qq'];
         $this->callback = Yii::$app->params['callback']['qq'];
     }
