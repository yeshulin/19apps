...
class ActionColumn extends \yii\grid\ActionColumn
{
     ...
     * @see buttons
     */
    public $template = '{view} {update} {delete}{pass}';
    /**
    ...
    protected function initDefaultButtons()
    {
		...
		if (!isset($this->buttons['pass'])) {
            $this->buttons['pass'] = function ($url, $model, $key) {
                $options = array_merge([
                    'title' => Yii::t('yii', 'pass'),
                    'aria-label' => Yii::t('yii', 'pass'),
					'data-confirm' => '确认通过?',
                    'data-pjax' => '0',
                ], $this->buttonOptions);
