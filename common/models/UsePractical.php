 ...
 */
class UsePractical extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['practical_code', 'practical_id', 'userid','status'], 'required'],
            [[ 'userid', 'status','practical_id', 'created_at'], 'integer'],
            [['practical_code'], 'string', 'max' => 200],
        ];
    }
     ...
     * @inheritdoc
     */
    public function attributePracticalels()
    {
        return [
            'id' => 'ID',
